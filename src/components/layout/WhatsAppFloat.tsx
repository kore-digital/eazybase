 ...
 * sticky CTA bar). Brand-styled dark-green circle — never the old plugin
 * red. A soft ring pulses out roughly every 8 seconds to draw the eye;
  ...
  return (
    <div className="fixed right-6 bottom-6 z-40 hidden md:block">
      ...
      <motion.a
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-brand-800 text-white shadow-lg shadow-ink-950/25 transition-colors hover:bg-brand-700"
